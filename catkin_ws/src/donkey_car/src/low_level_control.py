...
class ServoConvert():
    def __init__(self, id=1, center_value=333, range=70, direction=1):
        self.value      = 0.0
    ...
    def get_value_out(self, value_in):
        ...
        rospy.loginfo("Get value out: %d", self.value_out)
...
class DkLowLevelCtrl():
    def __init__(self):
        ...
        self.actuators = {}
        self.actuators['steering']  = ServoConvert(id=1, center_value=300,direction = -1)
        self.actuators['throttle']  = ServoConvert(id=2, center_value=300, range = 70) #-- positive left
